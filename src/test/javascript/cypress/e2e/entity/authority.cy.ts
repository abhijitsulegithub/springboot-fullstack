...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '578d2ff1-02bc-41b5-bb3c-ae4308440798' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('8d485145-adf3-4ca6-9ab1-1693b26562e3');
      cy.get(`[data-cy="name"]`).should('have.value', '8d485145-adf3-4ca6-9ab1-1693b26562e3');
